...
class Quiz {
  constructor(
    ...
    this.quiz1 = {
      ...
      answers: shuffleQuizAnswers([
        quiz1.correct_answer,
        ...quiz1.incorrect_answers,
      ]),
    };
    this.quiz2 = {
      ...
      answers: shuffleQuizAnswers([
        quiz2.correct_answer,
        ...quiz2.incorrect_answers,
      ]),
    };
    this.quiz3 = {
      ...
      answers: shuffleQuizAnswers([
        quiz3.correct_answer,
        ...quiz3.incorrect_answers,
      ]),
    };
    this.quiz4 = {
      ...
      answers: shuffleQuizAnswers([
        quiz4.correct_answer,
        ...quiz4.incorrect_answers,
      ]),
    };
    this.quiz5 = {
      ...
      answers: shuffleQuizAnswers([
        quiz5.correct_answer,
        ...quiz5.incorrect_answers,
      ]),
    };
    this.quiz6 = {
      ...
      answers: shuffleQuizAnswers([
        quiz6.correct_answer,
        ...quiz6.incorrect_answers,
      ]),
    };
    this.quiz7 = {
      ...
      answers: shuffleQuizAnswers([
        quiz7.correct_answer,
        ...quiz7.incorrect_answers,
      ]),
    };
    this.quiz8 = {
      ...
      answers: shuffleQuizAnswers([
        quiz8.correct_answer,
        ...quiz8.incorrect_answers,
      ]),
    };
    this.quiz9 = {
      ...
      answers: shuffleQuizAnswers([
        quiz9.correct_answer,
        ...quiz9.incorrect_answers,
      ]),
    };
    this.quiz10 = {
      ...
      answers: shuffleQuizAnswers([
        quiz10.correct_answer,
        ...quiz10.incorrect_answers,
      ]),
    };
  }
}
